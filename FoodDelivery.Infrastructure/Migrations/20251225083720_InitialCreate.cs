        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailOrPhone = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    MessageType = table.Column<string>(type: "text", nullable: false, defaultValueSql: "'text'"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionsSummary = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItemOption_ProductOptions_ProductOptionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Các loại nước uống", "Đồ Uống", 0 },
                    { 2, "Các món chính", "Đồ Ăn", 1 }
                });

            migrationBuilder.InsertData(
                table: "Conversations",
                columns: new[] { "Id", "CustomName", "EmailOrPhone", "IsClosed", "LastMessageAt", "SessionId", "StartedAt", "UserId" },
                values: new object[] { 1, "Khách hàng dùng thử", "0909123456", false, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "session-test-01", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Tên hiển thị", "store_name", "Cơm Tấm Đêm" },
                    { 2, "Hotline", "hotline", "0909123456" },
                    { 3, "Phí ship", "shipping_fee", "30000" },
                    { 4, "Min order", "min_order_value", "50000" },
                    { 5, "Banner", "banner_url", "/images/banner-tet.jpg" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedAt", "Description", "ImageUrl", "IsActive", "Name", "Price", "SortOrder", "StockQuantity" },
                values: new object[] { 100, 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ngon", "", true, "Trà Sữa Trân Châu", 20000m, 0, 50 });

            migrationBuilder.InsertData(
                table: "OptionGroups",
                columns: new[] { "Id", "AllowMultiple", "IsRequired", "Name", "ProductId" },
                values: new object[,]
                {
                    { 1, false, true, "Chọn Size", 100 },
                    { 2, true, false, "Thêm Topping", 100 }
                });

            migrationBuilder.InsertData(
                table: "ProductOptions",
                columns: new[] { "Id", "Name", "OptionGroupId", "PriceModifier" },
                values: new object[,]
                {
                    { 1, "Size M", 1, 0m },
                    { 2, "Size L", 1, 5000m },
                    { 3, "Trân châu đen", 2, 3000m },
                    { 4, "Thạch trái cây", 2, 3000m },
                    { 5, "Pudding trứng", 2, 5000m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemOption_ProductOptionId",
                table: "CartItemOption",
